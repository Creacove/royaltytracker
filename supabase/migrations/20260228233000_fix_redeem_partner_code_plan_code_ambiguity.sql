-- Fix ambiguous output-column collision in redeem_workspace_partner_code.
-- RETURNS TABLE includes `plan_code`, so unqualified `WHERE plan_code = ...`
-- can be interpreted as the output variable instead of table column.
