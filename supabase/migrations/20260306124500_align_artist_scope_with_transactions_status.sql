-- Align artist assistant scope with Transactions/Insights status policy.
-- Transactions grouping uses all non-failed reports, not only reviewed-complete subsets.
